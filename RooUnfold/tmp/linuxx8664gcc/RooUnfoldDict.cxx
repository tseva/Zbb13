...
#define R__DICTIONARY_FILENAME dIafsdIcerndOchdIuserdIjdIjlueticdIpublicdIZbbdICMSSW_7_4_11dIsrcdIDYJetsMYdIRooUnfolddItmpdIlinuxx8664gccdIRooUnfoldDict
...
"/afs/cern.ch/user/j/jluetic/public/Zbb/CMSSW_7_4_11/src/DYJetsMY/RooUnfold/src/",
"/afs/cern.ch/user/j/jluetic/public/Zbb/CMSSW_7_4_11/src/DYJetsMY/RooUnfold",
...
class __attribute__((annotate(R"ATTRDUMP(Unfolding base class: implementations in RooUnfoldBayes, RooUnfoldSvd, RooUnfoldBinByBin, RooUnfoldTUnfold, and RooUnfoldInvert)ATTRDUMP"))) __attribute__((annotate("$clingAutoload$src/RooUnfoldBayes.h")))  RooUnfold;
...
class __attribute__((annotate(R"ATTRDUMP(Respose Matrix)ATTRDUMP"))) __attribute__((annotate("$clingAutoload$src/RooUnfoldBayes.h")))  RooUnfoldResponse;
