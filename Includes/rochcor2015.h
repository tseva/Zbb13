...
class rochcor2015 {
 ...
 private:
  ...
  static constexpr double genm_smr = 9.09292e+01; //gen mass peak with eta dependent gaussian smearing => better match in Z mass profile vs. eta/phi
  ...
  static constexpr double dgscl_stat = 3.62246e-03; //stat. error of global factor for mass peak in data 
