...
/// b-jets 
	...
	ZptBJets_Zexc2Bjet = newTH1D("ZptBJets_Zexc2B","Zpt (exc 2 b-jet)", "Zpt",  100, 0, 100.);
	ZptBJets_Zinc1Bjet = newTH1D("ZptBJets_Zinc1B","Zpt (inc 1 b-jet)", "Zpt",  100, 0, 100.);
        ZptBJets_Zinc2Bjet = newTH1D("ZptBJets_Zinc2B","Zpt (inc 2 b-jet)", "Zpt",  100, 0, 100.);
        ZptBJets_Zinc3Bjet = newTH1D("ZptBJets_Zinc3B","Zpt (inc 3 b-jet)", "Zpt",  100, 0, 100.);
	BJetsMass_Zinc2Bjet= newTH1D("BJetsMass_Zinc2", "b-jet mass inc 2 b-jet ","b jet mass",  100, 0, 100.);
	FirstBJetPt_Zinc1Bjet = newTH1D("FirstBJetPt_Zinc1B","b-jet pt (inc 1 b jet)","b-jet pt", 100, 0, 100.);
	FirstBJetPt_Zinc2Bjet = newTH1D("FirstBJetPt_Zinc2B","b-jet pt (inc 2 b jet)","b-jet pt", 100, 0, 100.);
	SecondBJetPt_Zinc2Bjet = newTH1D("SecondBJetPt_Zinc2B","b-jet pt (inc 2 b jet)","b-jet pt", 100, 0, 100.);
	...
	ZptBJets_Zexc1Bjet_l = newTH1D("ZptBJets_Zexc1B_l","Zpt (exc 1 b-jet)", "Zpt",  100, 0, 100.  );
	ZptBJets_Zexc2Bjet_l = newTH1D("ZptBJets_Zexc2B_l","Zpt (exc 2 b-jet)", "Zpt",  100, 0, 100.);
	ZptBJets_Zinc1Bjet_l = newTH1D("ZptBJets_Zinc1B_l","Zpt (inc 1 b-jet)", "Zpt",  100, 0, 100.);
        ZptBJets_Zinc2Bjet_l = newTH1D("ZptBJets_Zinc2B_l","Zpt (inc 2 b-jet)", "Zpt",  100, 0, 100.);
        ZptBJets_Zinc3Bjet_l = newTH1D("ZptBJets_Zinc3B_l","Zpt (inc 3 b-jet)", "Zpt",  100, 0, 100.);
	BJetsMass_Zinc2Bjet_l = newTH1D("BJetsMass_Zinc2_l", "b-jet mass inc 2 b-jet ","b jet mass",  100, 0, 100.);
	FirstBJetPt_Zinc1Bjet_l = newTH1D("FirstBJetPt_Zinc1B_l","b-jet pt (inc 1 b jet)","b-jet pt", 100, 0, 100.);
	FirstBJetPt_Zinc2Bjet_l = newTH1D("FirstBJetPt_Zinc2B_l","b-jet pt (inc 2 b jet)","b-jet pt", 100, 0, 100.);
	SecondBJetPt_Zinc2Bjet_l = newTH1D("SecondBJetPt_Zinc2B_l","b-jet pt (inc 2 b jet)","b-jet pt", 100, 0, 100.);
	...
	ZptBJets_Zexc1Bjet_c = newTH1D("ZptBJets_Zexc1B_c","Zpt (exc 1 b-jet)", "Zpt",  100, 0, 100.  );
	ZptBJets_Zexc2Bjet_c = newTH1D("ZptBJets_Zexc2B_c","Zpt (exc 2 b-jet)", "Zpt",  100, 0, 100.);
	ZptBJets_Zinc1Bjet_c = newTH1D("ZptBJets_Zinc1B_c","Zpt (inc 1 b-jet)", "Zpt",  100, 0, 100.);
        ZptBJets_Zinc2Bjet_c = newTH1D("ZptBJets_Zinc2B_c","Zpt (inc 2 b-jet)", "Zpt",  100, 0, 100.);
        ZptBJets_Zinc3Bjet_c = newTH1D("ZptBJets_Zinc3B_c","Zpt (inc 3 b-jet)", "Zpt",  100, 0, 100.);
	BJetsMass_Zinc2Bjet_c = newTH1D("BJetsMass_Zinc2_c", "b-jet mass inc 2 b-jet ","b jet mass",  100, 0, 100.);
	FirstBJetPt_Zinc1Bjet_c = newTH1D("FirstBJetPt_Zinc1B_c","b-jet pt (inc 1 b jet)","b-jet pt", 100, 0, 100.);
	FirstBJetPt_Zinc2Bjet_c = newTH1D("FirstBJetPt_Zinc2B_c","b-jet pt (inc 2 b jet)","b-jet pt", 100, 0, 100.);
	SecondBJetPt_Zinc2Bjet_c = newTH1D("SecondBJetPt_Zinc2B_c","b-jet pt (inc 2 b jet)","b-jet pt", 100, 0, 100.);
	...
	ZptBJets_Zexc1Bjet_b = newTH1D("ZptBJets_Zexc1B_b","Zpt (exc 1 b-jet)", "Zpt",  100, 0, 100.  );
	ZptBJets_Zexc2Bjet_b = newTH1D("ZptBJets_Zexc2B_b","Zpt (exc 2 b-jet)", "Zpt",  100, 0, 100.);
	ZptBJets_Zinc1Bjet_b = newTH1D("ZptBJets_Zinc1B_b","Zpt (inc 1 b-jet)", "Zpt",  100, 0, 100.);
        ZptBJets_Zinc2Bjet_b = newTH1D("ZptBJets_Zinc2B_b","Zpt (inc 2 b-jet)", "Zpt",  100, 0, 100.);
        ZptBJets_Zinc3Bjet_b = newTH1D("ZptBJets_Zinc3B_b","Zpt (inc 3 b-jet)", "Zpt",  100, 0, 100.);
	BJetsMass_Zinc2Bjet_b = newTH1D("BJetsMass_Zinc2_b", "b-jet mass inc 2 b-jet ","b jet mass",  100, 0, 100.);
	FirstBJetPt_Zinc1Bjet_b = newTH1D("FirstBJetPt_Zinc1B_b","b-jet pt (inc 1 b jet)","b-jet pt", 100, 0, 100.);
	FirstBJetPt_Zinc2Bjet_b = newTH1D("FirstBJetPt_Zinc2B_b","b-jet pt (inc 2 b jet)","b-jet pt", 100, 0, 100.);
